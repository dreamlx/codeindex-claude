---
name: arch
description: This skill should be used when the user asks "what does this project do", "where is X implemented", "how does module Y work", or wants to understand a codebase's structure and architecture. Reads README_AI.md index files generated by codeindex instead of scanning source files directly.
version: 0.1.3
---
